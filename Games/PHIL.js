let words = [
    //philosophers
    "Socrates", "Plato", "Aristotle", "Confucius", "Epicurus", "Epictetus", "Aurelius", "Augustine", "Aquinas", "Descartes", "Spinoza", "Locke", "Hume", "Kant", "Nietzsche", "Rousseau", "Hegel", "Schopenhauer", "Marx", "Kierkegaard", "Engels", "Mill", "James", "Husserl", "Heidegger", "Wittgenstein", "Russell", "Sartre", "Merleau-Ponty", "Derrida", "Foucault", "Habermas", "Rorty", "Nussbaum", "Zizek", "Badiou", "Butler", "West", "Singer", "Chomsky", "Dawkins", "Dennett", "Harris", "Pinker", "Sandel", "Ronell", "Harman", "Meillassoux", "Brassier", "Morton", "Haraway", "Sontag", "Montaigne", "Bacon", "Dewey", "Benjamin", "Arendt", "Adorno", "Horkheimer", "Marcuse", "Strauss", "Schmitt", "Gadamer", "Levinas", "Lacan", "Baudrillard", "Deleuze", "Guattari", "Ricoeur", "Agamben", "Kristeva", "Mouffe", "Brown", "Laclau", "Shklar", "Sennett", "Said", "Bhabha", "Spivak", "Soja", "Lefebvre", "Gramsci", "Anderson", "Latour", "Bennett", "Barad", "Mbembe", "Wynter", "Snyder", "Stanley", "Davis", "Crenshaw", "DiAngelo", "Coates", "Rankine", "hooks", "Said",
    //Branches
